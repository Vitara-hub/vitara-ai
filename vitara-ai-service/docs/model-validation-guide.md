...
## 📌 Ringkasan
Script validasi ini berfungsi sebagai *gatekeeper* untuk memastikan semua model (NLP, Vision, Secondary) telah memenuhi target metrik yang ditetapkan dalam project plan.
...
- `data/`: Berisi dataset hasil preprocessing (`test.csv` atau direktori gambar).
